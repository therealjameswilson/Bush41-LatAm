...
objects, source page ranges, duplicate Scowcroft cross-reference provenance, and project-PDF
construction remains in structured metadata or the expanded provenance trail rather than the visible
Source note.
